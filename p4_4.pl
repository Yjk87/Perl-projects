...
my $q = CGI->new;
my $url = "/ykwon22/cgi-bin/p4_4.pl";
print header;
print start_html('A Base and CpG Counter'),
...
foreach my $element (@data) {
	...
	print "There are $count sequences in the file", br;
	...
	print "Total sequence length = $ltotalseq", br;
	...
	print "Maximum sequence length = $maxseq", br;
...
print "Minimum sequence length = $minseq", br;
...
#removing a whole-sequence-display for the visibility
#   print "$sequence[$i]";
